# -*- coding: utf-8 -*-
"""
Created on Fri Jul 22 21:51:44 2022
...
class Key():
    ...
    def drawKey(self, img, text_color=(255,255,255), bg_color=(100 , 100, 0),alpha=0.5, fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=0.8, thickness=2):
